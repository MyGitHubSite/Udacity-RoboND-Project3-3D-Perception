...
def compute_color_histograms(cloud, using_hsv=False):
    ...
    channel_1_hist, bin_edges = np.histogram(channel_1_vals, bins=16, range=(0, 256))
    channel_2_hist, bin_edges = np.histogram(channel_2_vals, bins=16, range=(0, 256))
    channel_3_hist, bin_edges = np.histogram(channel_3_vals, bins=16, range=(0, 256))
